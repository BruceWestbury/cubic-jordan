...
For the numbers of connected trivalent graphs of girth at least five with $t$ vertices see \oeis{A014372}.
See Table~\ref{table:f4}.
...
We implemented this procedure and applied it for $t=14,16,18,20,22$. See Table~\ref{table:e6}.
\begin{table}[h]
	\begin{equation*}
		\begin{array}{rrrrr}
